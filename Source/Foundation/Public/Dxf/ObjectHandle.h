...
public:
    ...
    FObjectId GetId() const noexcept { return m_Id; }
    template <typename U> TObjectHandle<U> Cast() const noexcept { return TObjectHandle<U>(m_pDomain, m_Id); }
    bool operator==(const TObjectHandle& Other) const noexcept { return m_Id == Other.m_Id; }
private:
