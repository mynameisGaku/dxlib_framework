...
public:
    ...
    std::uint64_t GetScope() const noexcept { return m_Scope; }
    bool IsHandleAccessible_Internal() const noexcept override { return m_Handle.Get() >= 0; }
private:
