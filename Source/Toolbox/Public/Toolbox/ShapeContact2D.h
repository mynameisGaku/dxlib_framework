...
#ifndef TOOLBOX_SHAPE_CONTACT_2D_H
#define TOOLBOX_SHAPE_CONTACT_2D_H
#include "Toolbox/Optional.h"
#include "Toolbox/Vector2.h"
namespace Toolbox
{
/**
 * 円と静止した対象の現在位置での接触・分離。移動は含まない。
 */
struct FShapeContact2D
{
	/**
	...
	f64 Separation = 0;
	/**
	 * 分離が最も速く増える単位方向（対象から円の中心へ向く向き）。円の中心が対象の外なら最近点から中心への方向、
