...
public:
    ...
    TResult<void> Prepare(DScene& Scene, const FInitContext& Context) { return Scene.Initialize_Internal(Context); }
    void Activate(DScene& Scene, const FSceneActivationContext& Context) noexcept { Scene.Enter_Internal(Context); }
