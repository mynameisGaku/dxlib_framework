...
public:
    ...
    bool IsRunning() const noexcept { return m_bStarted && !m_bShutdown && !m_bShutdownRequested; }
    FSceneNavigator& GetScenes() noexcept { return m_Scenes; }
    FAssetService& GetAssets() noexcept { return m_Assets; }
    FRenderSystem2D& GetRenderer() noexcept { return m_Renderer; }
    DGameInstance* GetGameInstance() noexcept { return m_pGame.get(); }
private:
