...
#ifndef DXF_WORLD_CONTACT_3D_H
#define DXF_WORLD_CONTACT_3D_H
...
{
/**
 * 問い合わせ球と一つのColliderの、問い合わせ時点の接触・分離。後のWorld変更に対するIDの生存保証はない。
 */
struct FWorldContact3D
{
	/**
	...
	/**
	 * 分離が最も速く増える単位方向（対象から球の中心へ向く向き）。同心や同じ距離の面が複数ある場合など、
