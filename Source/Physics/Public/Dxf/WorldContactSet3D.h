...
#ifndef DXF_WORLD_CONTACT_SET_3D_H
#define DXF_WORLD_CONTACT_SET_3D_H
#include "Dxf/WorldContact3D.h"
...
struct FWorldContactSet3D
{
	 ...
	 */
	Toolbox::TArray<FWorldContact3D, Capacity> Items;
	/**
