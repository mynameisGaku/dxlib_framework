...
#ifndef DXF_WORLD_SLIDE_MOVE_2D_H
#define DXF_WORLD_SLIDE_MOVE_2D_H
#include "Dxf/RigidBody2D.h"
#include "Dxf/WorldSlideResult2D.h"
namespace Dxf
{
/**
 * 円を希望終点へ動かす候補を、SweepClosestの組合せで計算する（読み取り専用）。Worldは変更しない。
 ...
 * @param StartShape 開始時の円。半径は有限の正の値（点の滑りは提供しない）。2D物理ワールド座標。
