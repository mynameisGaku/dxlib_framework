...
{
public:
    DGameScene() { AttachChildren_Internal(m_Objects); }
    ...
    template <typename T> bool Destroy(TObjectHandle<T> Object) noexcept { return m_Objects.Destroy(Object); }
    std::size_t GetObjectCount() const noexcept { return m_Objects.Size(); }
private:
