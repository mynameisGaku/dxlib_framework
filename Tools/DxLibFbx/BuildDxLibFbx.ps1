...
$Manifest = [ordered]@{
    dxlib_version = '3.25a'
    with_fbx = (-not $NoFbx)
    model_extension_version = 3
    pbr_shader_sha256 = (Get-Sha256 (Join-Path $PSScriptRoot 'ModelPbr.hlsl'))
    pbr_extension_sha256 = (Get-Sha256 (Join-Path $PSScriptRoot 'DxLibPbrExtension.cpp'))
