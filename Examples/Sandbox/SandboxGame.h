...
{
public:
    void RecordSceneVisit() noexcept { ++m_SceneVisits; }
    int GetSceneVisits() const noexcept { return m_SceneVisits; }
private:
    int m_SceneVisits = 0;
};
...
public:
    ...
    const FVector2& GetPosition() const noexcept { return m_Position; }
protected:
...
public:
    ...
    TObjectHandle<DPlayer> GetPlayer() const noexcept { return m_Player; }
protected:
